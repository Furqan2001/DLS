...
const NewLand = ({
  ...
  const [formState, setFormState] = useState<IIPFSRecord>(
    defaultFormState || {
      ...
      mapPoints: [
        {
          lat: 39.048317225597536,
          lng: -7.774847473563475,
        },
        {
          lat: 39.116541415446896,
          lng: -6.017034973563475,
        },
        {
          lat: 37.4959014780169,
          lng: -5.841253723563475,
        },
        {
          lat: 37.391230029157384,
          lng: -7.555120911063475,
        },
        {
          lat: 39.048317225597536,
          lng: -7.774847473563475,
